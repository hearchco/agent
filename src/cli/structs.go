...
type Flags struct {
	...
	DataDirPath string `type:"path" default:"${data_folder}" env:"BRZAGUZA_DATA_DIR" help:"Data folder path"`
	LogDirPath  string `type:"path" default:"${log_folder}" env:"BRZAGUZA_LOG_DIR" help:"Log folder path"`
